...
| File | Content |
|------|---------|
| `aegis/reports/inventory.md` | Complete project inventory |
| `aegis/reports/dependencies.md` | Dependencies with versions |
| `aegis/runtime/context/surface.json` | Structured data for the other agents |
