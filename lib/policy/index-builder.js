...
//
// Walks `aegis/specs/sdd/`, parses YAML frontmatter from each spec,
// extracts:
//   - contracts: [{ name, file, protected, reason }]
//   - protected_files: [glob, ...]
//
// Aggregates into `aegis/runtime/context/policy-index.json` for fast lookup
// at hook time.
//
// Schema:
//   {
...
//     "built_at": "...",
//     "specs": {
//       "aegis/specs/sdd/auth.md": { protected_globs: [...], contracts: [...] }
//     },
...
const SDD_REL = 'aegis/specs/sdd';
const POLICY_INDEX_REL = 'aegis/runtime/context/policy-index.json';
