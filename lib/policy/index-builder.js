...
//
// Walks `_aegis_sdd/sdd/`, parses YAML frontmatter from each spec,
// extracts:
//   - contracts: [{ name, file, protected, reason }]
//   - protected_files: [glob, ...]
//
// Aggregates into `.aegis/context/policy-index.json` for fast lookup
// at hook time.
//
// Schema:
//   {
...
//     "built_at": "...",
//     "specs": {
//       "_aegis_sdd/sdd/auth.md": { protected_globs: [...], contracts: [...] }
//     },
...
const SDD_REL = '_aegis_sdd/sdd';
const POLICY_INDEX_REL = '.aegis/context/policy-index.json';
