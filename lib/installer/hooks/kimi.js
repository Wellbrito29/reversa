...
//
// Marker-based isolation: entries are bracketed by Aegis Spec-managed
...
export default {
  ...
  generate({ projectRoot, runnerPath }) {
    ...
    const summary = [
      ...
      `  Existing config preserved; Aegis Spec section bracketed by markers.`,
      `  Backup will be saved as: ${target}.bak.aegis-<timestamp>`,
    ];
