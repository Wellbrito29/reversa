        ...
        content: [
          {
            ...
            text: [
              deletedFile
                ? `The source file \`${deletedFile}\` has been deleted. Remove all references to it from this spec. Do not invent replacement content — simply omit the stale reference and adjust surrounding prose for coherence.`
